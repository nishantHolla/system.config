...
Personal NixOS + Home Manager configuration, AwesomeWM setup, helper shell utilities, and a
small Python CLI used to bootstrap and manage the system.

> This repository is opinionated and tuned for my environment. It can still be a strong template
if you want a flake-based Linux setup with modular config files and scriptable workflows.
